...
![Empresas Disney](./fotos/empresas_disney.jpeg)
<br>
...
datos1 <- here::here("datos", "disney_movies.csv")

aa <- rio::import(datos1) 

datos2 <- here::here("datos", "charcters_stats_a.csv")

bb <- rio::import(datos2)


datos3 <- here::here("datos", "marvelpersonajes.csv")

cc <- rio::import(datos3)

datos4 <- here::here("datos", "marvelwiki.csv")
...
![Final Disney](./fotos/personajes_disney.jpg)
<br>
...
![Logo Marvel](./fotos/logo_marvel.png)
...
![Personajes Marvel](./fotos/personajes_marvel.jpg)
<br>
